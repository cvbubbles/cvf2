...
#define NETCALL_INCLUDE_SOCKET 1
#endif

#if NETCALL_INCLUDE_SOCKET
...
public:
	static int32 nct_to_cv(int32 type)
	{
		...
		return type == nct_char ? CV_8S : type == nct_uchar ? CV_8U
	...
	{
		return cvt == CV_8S ? nct_char : cvt == CV_8U ? nct_uchar
...
private:
	...
	static int32 _get_nct(int32_t) { return nct_int32; }
	static int32 _get_nct(uint32_t) { return nct_uint32; }
	static int32 _get_nct(int64_t) { return nct_int64; }
	static int32 _get_nct(uint64_t) { return nct_uint64; }
...
private:
	...
	//_ValT can be Point_, Vec_, etc. that are supported by cv::InputArray
	template <typename _ValT>
